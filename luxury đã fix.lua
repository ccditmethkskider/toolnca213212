...
if type(getgenv().Configs) ~= "table" then
	getgenv().Configs = {
		...
		Webhook = {
			...
			StartWebhook = true,
			WebhookURL = "https://discord.com/api/webhooks/1283638463672881172/rkb5uugZDQvLOL4epJSI51zf1VXLPcvdh4daCm0PzcFrZ7bsYVeYKuF9hhbCheLGet2R",
...
local luxury_table = loadstring(game:HttpGet("https://raw.githubusercontent.com/KhanhTranVan/HungHubUI/refs/heads/main/LoadingUI"))()
