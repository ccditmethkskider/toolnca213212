...
local function AddESP(Part, ESPColor)
  if Part and Part:FindFirstChild("ESP_DucsharelinkHub") then
    return
  end
  
  local Folder = Instance.new("Folder", Part)
  Folder.Name = "ESP_DucsharelinkHub"
  
  local BHA = Instance.new("BoxHandleAdornment", Folder)
  BHA.Size = Vector3.new(1, 0, 1, 0)
  BHA.Name = "ESP_DucsharelinkHub"
...
local function Get_LevelQuest()
  ...
  elseif Sea3 then
    -- Auto Farm Level Sea 3 (siêu múp)
...
local Window = Fluent:CreateWindow({
  Title = "Ducsharelink Hub : Blox Fruits",
  SubTitle = "Ducsharelink Lite",
  TabWidth = 160,
