...
-- Nếu đang nhảy, áp dụng trọng lực
if is_jumping then
...
if key == "space" and not is_jumping then
    is_jumping = true
    player.velocityY = -jump_strength  -- Sử dụng giá trị từ slider
end
end
