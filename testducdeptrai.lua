...
local function playSound()
    ...
    sound.SoundId = "rbxassetid://131682385535624"
    sound.Volume = 10
    sound:Play()
end
...
local Toggle = Tabs.Main:AddToggle("Bypass TP", { Title = "Dừng TP Bypass khi có huyền thoại", Default = false })
Toggle:OnChanged(function(Value)
    _G.StopTP = Value
end)
...
local Toggle = Tabs.Main:AddToggle("Turn V4", { Title = "Auto Bật Tộc V4", Default = false })
Toggle:OnChanged(function(Value)
    RaceNguLon = Value
end)
...
local Toggle = Tabs.item:AddToggle("Auto Ectoplasm", { Title = "Mua Kiếm Legendary", Default = false })
...
local Toggle = Tabs.item:AddToggle("auto Change", { Title = "Thay đổi haki", Default = false })
Toggle:OnChanged(function(Value)
Gan_Haki_Lon = Value
...
local Toggle = Tabs.item:AddToggle("auto Kill", { Title = "Auto Rip_Indra", Description = "Đọ vòi voi với Rip", Default = false })
Toggle:OnChanged(function(Value)
...
local Toggle = Tabs.item:AddToggle("Auto Eliter Hunter", { Title = "Auto Raid Hải Tặc", Default = false })
Toggle:OnChanged(function(Value)
    _G.RaidPirate = Value
...
local Toggle = Tabs.item:AddToggle("auto Change", { Title = "Auto Dough King + Farm Item", Description = "Đọ chem chép với Dough", Default = false })
Toggle:OnChanged(function(Value)
...
local LinhTinh = Tabs.an:AddSection("Chức năng phụ")
...
local Toggle = Tabs.an:AddToggle("Walk Water", { Title = "Auto Rejoin", Description = "Join lại nếu bị kick", Default = false })
Toggle:OnChanged(function(Value)
    _G.Rejoin = Value
end)                          
...
local Toggle = Tabs.an:AddToggle("RemoveConMe", { Title = "Remove Damege", Description = "Xóa Damege", Default = true })
...
local Toggle = Tabs.an:AddToggle("RemoveConMe", { Title = "Remove Notify", Description = "Xóa thông báo khi farm", Default = false })
Toggle:OnChanged(function(AnDepZaiHubOnTop)
...
Tabs.an:AddButton({
    ...
    Description = "Nhìn stock fruit trên đảo",
    Callback = function()
...
local Toggle = Tabs.Race:AddToggle("Teleport Gear", { Title = "Teleport ông bán Fruit", Default = false })
Toggle:OnChanged(function(Value)
    _G.RaDaoKhi = Value
...
local Toggle = Tabs.Race:AddToggle("Auto Complete Trial", { Title = "Auto Win Ải", Default = false })
...
local Toggle = Tabs.Race:AddToggle("Kill Trial", { Title = "Kill Tất Cả Player", Default = false })
Toggle:OnChanged(function(Value)
    _G.Kill_V4 = Value
