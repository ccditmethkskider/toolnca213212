...
NotificationLibrary:SendNotification("Warning", "loading script", 10)
NotificationLibrary:SendNotification("Warning", "script by kaibeo vn", 10)
NotificationLibrary:SendNotification("Warning", "welcome ziner hub", 10)
...
ImageButton.Image = "rbxassetid://85184272577967"
...
local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Damege Aura", Default = false })
 ...
 local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Click No Cooldown", Default = false })
