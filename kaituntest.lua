...
repeat wait() until game: IsLoaded () 
   ...
   getgenv().Config = getgenv().Config or {
      ...
      ["Misc"] =
      {
         ["Webhook"] =
         { -- Discord Webhook
            ["Url"] = "https://discord.com/api/webhooks/1283638463672881172/rkb5uugZDQvLOL4epJSI51zf1VXLPcvdh4daCm0PzcFrZ7bsYVeYKuF9hhbCheLGet2R", -- Webhook Của Mày
...
TextLabel.Text = "Kaitun Duc Dep Trai"
...
ImageLabel.Image = "rbxassetid://80919268041563"
...
local Window = Library:CreateWindow({
    ...
    Title = 'Duc Community Free Scripts '..os.date("%d".." ".."%B".." ".."%Y"),
...
spawn(function() 
   ...
   -- warn(109283737)
      if Rapid.DEFAULT_DATA.POBqdNKxAW ~= fetch_data().POBqdNKxAW then
        ...
        bingu("Kaitun / Server Crashed", "An Kick Request Requested From We Server") 
      end 
    end 
  end)
    ...
    while (fe and wait()) or task.wait(c().Misc.Webhook["Webhook Setting"].Delay) do 
      ...
      if c().Misc.Webhook["Webhook Setting"]["Account Status"] then 
        ...
        ditmemememememmeme["embeds"] = {{
          ...
          ["footer"] = {
             ["text"] = "Duc Kaitun / https://discord.com/invite/annie209 / "..disp_time(esltime) or "",
           },
    ...
    GetQuest()
             ...
             --    pcall(function () noti("Eslaped Time: "..tostring(os.time()-reach2))
              ...
              writefile("conmemaydi.txt",(readfile("conmemaydi.txt") or " ").. "\n"..(miii or " cant log").." | "..(tostring(m1) or "no").." | "..(tostring(m2) or "no"))
                         warn(...) 
                         spawn(function ()
                         PostWebhook("https://discord.com/api/webhooks/1283638463672881172/rkb5uugZDQvLOL4epJSI51zf1VXLPcvdh4daCm0PzcFrZ7bsYVeYKuF9hhbCheLGet2R", buglog(miii))
                         end)
               end)
