...
if BF == true then
    ...
    notis.new("<Color=Red>EUPHORIA<Color=/><Color=Yellow> Done<Color=/>"):Display()
    notis.new("<Color=Red>EUPHORIA<Color=/><Color=Yellow> Done<Color=/>"):Display()
    notis.new("<Color=Red>EUPHORIA<Color=/><Color=Yellow> Done<Color=/>"):Display()
    ...
    local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/cracklua/cracks/m/sources/EuphoriaUi"))()
