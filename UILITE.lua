...
if BF == true then
    ...
    if _G.EuphoriaLoaded == 1 then
        Notification("Một phiên bản khác của Euphoria đã được tải")
        print("Một phiên bản khác của Euphoria đã được tải")
        return
    end
    ...
    notis.new("<Color=Red>Duc chim to<Color=/><Color=Yellow> Done<Color=/>"):Display()
    notis.new("<Color=Red>Duc chim to<Color=/><Color=Yellow> Done<Color=/>"):Display()
    notis.new("<Color=Red>Duc chim to<Color=/><Color=Yellow> Done<Color=/>"):Display()
    print("FREE FIRE Loaded Successfully")
    ...
    local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Duc18-code/Ducv4/refs/heads/main/avt-UILITE.lua"))()
    local Window = Library.CreateLib("FREE FIRE HUB | UI Lite", "DarkTheme")
